...
public class JoinBean {
	...
	public void setMEM_HOME_PHONE(String mEM_HOME_PHONE) {
		MEM_HOME_PHONE = mEM_HOME_PHONE;
	}
	public String getMEM_CELL_PHONE() {
		return MEM_CELL_PHONE;
	}
	public void setMEM_CELL_PHONE(String mEM_CELL_PHONE) {
		MEM_CELL_PHONE = mEM_CELL_PHONE;
	}
	public String getGRADE_ST_PK() {
		return GRADE_ST_PK;
	}
	public void setGRADE_ST_PK(String gRADE_ST_PK) {
		GRADE_ST_PK = gRADE_ST_PK;
	}
	public Date getMEM_JOIN_DT() {
		return MEM_JOIN_DT;
	}
