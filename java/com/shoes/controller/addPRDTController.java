...
public class addPRDTController{
	...
	public String addPRDT(){
		return "admin/addPRDT";
												...
												// ModelAttribute는 항상 RequestMapping된 메서드보다 먼저 실행된다. 메서드명은
	@ModelAttribute 							// 자유롭게 지어도 되며, 보통 폼백킹이라고 지어준다.
	public PRDTCommonBean formBacking(){ 		// 즉, 여기서 생성한 MemberVO를 디스패쳐서블릿 객체로
												// 반환하고,
		return new PRDTCommonBean(); 			// 디스패쳐 서블릿에선 클라이언트로부터 날아온 form 데이타를
