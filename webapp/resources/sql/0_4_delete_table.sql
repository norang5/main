...
-- 중고거래 게시글 댓글
DROP SEQUENCE UTP_COMMENT_TB_SEQ;
...
-- 마일리지 적립 내역 -> 회원정보
ALTER TABLE MILEAGE_HISTORY_TB drop CONSTRAINT MILEAGE_HTR_TB_MEM_EMAIL_PK_FK;

-- 비밀번호 찾기 -> 비밀번호 찾기 질문 분류
ALTER TABLE PW_FIND_TB DROP CONSTRAINT PW_FIND_TB_PW_FIND_ASK_PK_FK;

-- 비밀번호 찾기 -> 회원정보
ALTER TABLE PW_FIND_TB DROP CONSTRAINT PW_FIND_TB_PW_MEM_EMAIL_PK_FK;

-- 수령자 정보 -> 회원정보
ALTER TABLE RECEIVER_INFO_TB drop CONSTRAINT RCVR_INF_TB_MEM_EMAIL_PK_FK;
...
-- 중고거래 게시글 -> 회원정보
ALTER TABLE USED_TRADE_POST_TB drop CONSTRAINT USE_TRD_PST_TB_MEM_EMAIL_PK_FK;
...
ALTER TABLE UTP_COMMENT_TB DROP CONSTRAINT UTPC_TB_UTP_SQ_PK_FK;

-- 중고거래 게시글 댓글 -> 회원정보
ALTER TABLE UTP_COMMENT_TB DROP CONSTRAINT UTPC_TB_MEM_EMAIL_PK_FK;

-- 중고거래 게시글 댓글 -> 또다른 중고거래 게시글 댓글
ALTER TABLE UTP_COMMENT_TB DROP CONSTRAINT UTPC_TB_UTPC_SQ_PK_FK;

-- 선택한 상품 -> 상품
ALTER TABLE SELECT_PRDT_TB drop CONSTRAINT SELECT_PRDT_TB_PRDT_CD_PK_FK;

-- 선택한 상품 -> 회원정보
ALTER TABLE SELECT_PRDT_TB drop CONSTRAINT SELECT_PRDT_TB_MEM_EMAIL_PK_FK;
...
-- 상품 판매글 -> 회원정보
ALTER TABLE PRDT_POST_TB drop CONSTRAINT PRDT_POST_TB_MEM_EMAIL_PK_FK;

-- 한 줄 상품평 -> 상품 판매글
ALTER TABLE PRDT_COMMENT_TB drop CONSTRAINT PRDT_COMMENT_TB_PP_SQ_PK_FK;

-- 한 줄 상품평 -> 회원정보
ALTER TABLE PRDT_COMMENT_TB drop CONSTRAINT PRDT_CMMNT_TB_MEM_EMAIL_PK_FK;

-- 상품판매글 이미지 목록 -> 상품 판매글
ALTER TABLE PRDT_POST_IMG_LIST_TB drop CONSTRAINT PPIL_TB_PP_SQ_PK_FK;

-- 관심 상품글 -> 회원정보
ALTER TABLE INTEREST_TB drop CONSTRAINT INSERT_TB_MEM_EMAIL_PK_FK;
...
-- 주문 -> 회원정보
ALTER TABLE ORDER_TB drop CONSTRAINT ORDER_TB_MEM_EMAIL_PK_FK;
...
-- 비밀번호 찾기 질문 분류
ALTER TABLE PW_FIND_ASK_TB DROP PRIMARY KEY;

-- 비밀번호 찾기
ALTER TABLE PW_FIND_TB DROP PRIMARY KEY;
...
-- 중고거래 게시글 댓글
ALTER TABLE UTP_COMMENT_TB drop primary key;
...
-- 비밀번호 찾기 질문 분류
DROP TABLE PW_FIND_ASK_TB PURGE;

-- 비밀번호 찾기
DROP TABLE PW_FIND_TB PURGE;
...
-- 중고거래 게시글 댓글
DROP TABLE UTP_COMMENT_TB PURGE;
