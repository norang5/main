...
-- 치수명
CREATE TABLE PRDT_SIZE(
	PRDT_SIZE	VARCHAR2(10)	NOT NULL
);

-- 상품
CREATE TABLE PRDT_TB(
	PRDT_CD_PK	NUMBER(8)	NOT NULL,
	PRDT_SIZE	NUMBER(4)	NOT NULL,
	PRDT_COLOR	VARCHAR2(30)	NOT NULL,
	PRDT_PRICE	NUMBER(10000000)	NOT NULL,
	PRDT_AMT	NUMBER(100000)	NOT NULL,
	PCI_SQ_PK	NUMBER(8)	NOT NULL
);
...
CREATE TABLE USED_TRADE_POST_TB(
	...
	UTP_BODY			VARCHAR2(60000)	NOT NULL,
	...
	USED_TRADE_ST_PK	VARCHAR2(20)	NOT NULL,
	DISTRICT_PK			VARCHAR2(40)	NOT NULL,
	PRDT_SIZE_PK		VARCHAR2(10)	NOT NULL,
	USED_ST_GRADE_PK	VARCHAR2(20)	NOT NULL,
	PRDT_CD_PK			NUMBER(8)	NOT NULL
);
...
CREATE TABLE SELECT_PRDT_TB(
	...
	MEM_ID_PK		VARCHAR2(30)	NOT NULL,
	SLTPEDT_QUANTITY	NUMBER(10000)	NOT NULL,
...
CREATE TABLE PRDT_POST_TB(
	...
	PRDT_ST_NM_PK			VARCHAR2(60)	NOT NULL,
	PP_BODY				VARCHAR2(60000)	NOT NULL,
	DLVR_CHRG_NM_PK	VARCHAR2(60)	NOT NULL,
...
CREATE TABLE PRDT_COMMENT_TB(
	...
	PDCMM_BODY			VARCHAR2(60000)	NOT NULL,
...
CREATE TABLE PAYMENT_INFO_TB(
	...
	PAYINF_SUM				NUMBER(10000000)	NOT NULL,
	ORDER_SQ				NUMBER(8)	NOT NULL
);
...
ADD CONSTRAINT	MEMBER_TB_MEM_ID_PK
PRIMARY KEY(MEM_ID_PK);
...
ADD CONSTRAINT RECEIVER_INFO_TB_RINF_REGIT_DT_PK
PRIMARY KEY(RINF_REGIT_DT);
...
ADD CONSTRAINT DELIVERY_CHARGE_TB_DLVR_CHRG_NM_PK
PRIMARY KEY(DLVR_CHRG_NM_PK);

-- 상품 브랜드
ALTER TABLE PRDT_CATEGORY_TB
ADD CONSTRAINT PRDT_CATEGORY_TB_PRDT_BRAND_NM_PK
PRIMARY KEY(PRDT_BRAND_NM);

-- 상품 공통정보
ALTER TABLE PRDT_COMMON_INFO_TB
ADD CONSTRAINT PRDT_COMMON_INFO_TB_PCI_SQ_PK
...
-- 치수명
ALTER TABLE PRDT_SIZE
ADD CONSTRAINT PRDT_SIZE_PRDT_SIZE_PK
PRIMARY KEY(PRDT_SIZE);
...
ADD CONSTRAINT USED_TRADE_ST_TB_USED_TRADE_ST_PK
...
ADD CONSTRAINT USED_TRADE_POST_IMG_LIST_TB_UTPIL_SQ_PK
PRIMARY KEY(UTPIL_SQ_PK);

ALTER TABLE USED_TRADE_POST_IMG_LIST_TB
ADD CONSTRAINT USED_TRADE_POST_IMG_LIST_TBUTPIL_IMG_PATH_PK
PRIMARY KEY(UTPIL_IMG_PATH_PK);
...
ADD CONSTRAINT PRDT_POST_IMG_LIST_TB_PPIL_SQ_PK
...
FOREIGN kEY(MEM_ID_PK)
REFERENCES GRADE_ST_TB(GRADE_ST_PK);

-- 마일리지 적립내역 -> 회원정보
ALTER TABLE MILEAGE_HISTORY_TB
ADD CONSTRAINT MILEAGE_HISTORY_TB_MEM_ID_PK_FK
FOREIGN KEY(MEM_ID_PK)
REFERENCES MEMBER_TB(MEM_ID_PK);

-- 한 줄 상품평 -> 회원정보
ALTER TABLE PRDT_COMMENT_TB
ADD CONSTRAINT PRDT_COMMENT_TB_MEM_ID_PK_FK
FOREIGN KEY(MEM_ID_PK)
REFERENCES MEMBER_TB(MEM_ID_PK);
...
-- 상품 판매글 -> 배송비
ALTER TABLE PRDT_POST_TB
ADD CONSTRAINT PRDT_POST_TB_DLVR_CHRG_NM_PK_FK
...
-- 상품 판매글 -> 회원정보
ALTER TABLE PRDT_POST_TB
ADD CONSTRAINT PRDT_POST_TB_MEM_ID_FK
FOREIGN KEY(MEM_ID_PK)
REFERENCES MEMBER_TB(MEM_ID_PK);
...
-- 상품판매글 이미지 목록 -> 상품 판매글
ALTER TABLE PRDT_POST_IMG_LIST_TB
ADD CONSTRAINT PRDT_POST_IMG_LIST_TB_PP_SQ_PK_FK
FOREIGN KEY(PP_SQ_PK)
REFERENCES PRDT_COMMON_INFO_TB(PP_SQ_PK);

-- 상품 공통정보 -> 상품 브랜드
ALTER TABLE PRDT_COMMON_INFO_TB
ADD CONSTRAINT PRDT_COMMON_INFO_TB_PRDT_CTG_NM_FK
FOREIGN KEY(PRDT_CTG_NM)
REFERENCES PRDT_CATEGORY_TB(PRDT_CTG_NM);

-- 상품 대표 이미지 목록 -> 상품 공통정보
ALTER TABLE PRDT_REPRESENT_IMG_LIST_TB
ADD CONSTRAINT PRDT_REPRESENT_IMG_LIST_TB_PCI_SQ_PK_FK
FOREIGN KEY(PCI_SQ_PK)
REFERENCES PRDT_COMMON_INFO_TB(PCI_SQ_PK);
...
-- 선택한 상품 -> 회원정보
ALTER TABLE SELECT_PRDT_TB
ADD CONSTRAINT SELECT_PRDT_TB_MEM_ID_PK_FK
FOREIGN KEY(MEM_ID_PK)
REFERENCES MEMBER_TB(MEM_ID_PK);

-- 중고거래 게시글 -> 치수
ALTER TABLE USED_TRADE_POST_TB
ADD CONSTRAINT USED_TRADE_POST_TB_PRDT_SIZE_PK_FK
FOREIGN KEY(PRDT_SIZE_PK)
REFERENCES PRDT_SIZE_TB(PRDT_SIZE_PK);

-- 중고거래 게시글 -> 상태
ALTER TABLE USED_TRADE_POST_TB
ADD CONSTRAINT USED_TRADE_POST_TB_PRDT_CD_PK_FK;
FOREIGN KEY(PRDT_CD_PK)
REFERENCES PRDT_TB(PRDT_CD_PK);

-- 중고거래 게시글 -> 중고상품 상태
ALTER TABLE USED_TRADE_POST_TB
ADD CONSTRAINT USED_TRADE_POST_TB_USED_ST_GRADE_PK_FK
FOREIGN KEY(USED_ST_GRADE_PK)
REFERENCES USED_ST_TB(USED_ST_GRADE_PK);

-- 중고거래 게시글 -> 중고거래 상태
ALTER TABLE USED_TRADE_POST_TB
ADD CONSTRAINT USED_TRADE_POST_TB_USED_TRADE_ST_PK_FK
FOREIGN KEY(USED_TRADE_ST_PK)
REFERENCES USED_TRADE_ST_TB(USED_TRADE_ST_PK);

-- 중고거래 게시글 -> 지역
ALTER TABLE USED_TRADE_POST_TB
ADD CONSTRAINT USED_TRADE_POST_TB_DISTRICT_PK_FK
FOREIGN KEY(DISTRICT_PK)
REFERENCES DISTRICT_TB(DISTRICT_PK);

-- 중고거래 게시글 -> 회원정보
ALTER TABLE USED_TRADE_POST_TB
ADD CONSTRAINT USED_TRADE_POST_TB_MEM_ID_PK_FK
FOREIGN KEY(MEM_ID_PK)
REFERENCES MEMBER_TB(MEM_ID_PK);

-- 중고거래 게시글 이미지 리스트 -> 중고거래 게시글
ALTER TABLE USED_TRADE_POST_IMG_LIST_TB
ADD CONSTRAINT USED_TRADE_POST_IMG_LIST_TB_UTP_SQ_PK_FK
...
-- 주문 -> 회원정보
ALTER TABLE ORDER_TB
ADD CONSTRAINT ORDER_TB_MEM_ID_PK_FK
FOREIGN KEY(MEM_ID_PK)
REFERENCES MEMBER_TB(MEM_ID_PK);
...
-- 수령자 정보 -> 회원정보
ALTER TABLE RECEIVER_INFO_TB
ADD CONSTRAINT RECEIVER_INFO_TB_MEM_ID_PK_FK
FOREIGN KEY(MEM_ID_PK)
REFERENCES MEMBER_TB(MEM_ID_PK);

-- 결제정보 -> 결제방식
ALTER TABLE PAYMENT_INFO_TB
ADD CONSTRAINT PAYMENT_INFO_TB_PAY_PLAN_NM_PK_FK
FOREIGN KEY(PAY_PLAN_NM_PK)
REFERENCES PAYMENT_PLAN_TB(PAY_PLAN_NM_PK);

-- 결제정보 -> 주문
ALTER TABLE PAYMENT_INFO_TB
ADD CONSTRAINT PAYMENT_INFO_TB_ORDER_SQ_PK_FK
FOREIGN KEY(ORDER_SQ_PK)
REFERENCES ORDER_TB(ORDER_SQ_PK);

-- 관심 상품글 -> 상품 판매글
ALTER TABLE INSERT_TB
...
-- 관심 상품글 -> 회원정보
ALTER TABLE INSERT_TB
ADD CONSTRAINT INSERT_TB_MEM_ID_PK_FK
FOREIGN KEY(MEM_ID_PK)
REFERENCES MEMBER_TB(MEM_ID_PK);
