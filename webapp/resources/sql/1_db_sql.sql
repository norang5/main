...
ADD CONSTRAINT RECEIVER_INF_TB_REGIT_DT_PK
...
ADD CONSTRAINT PRDT_CTG_TB_BRAND_NM_PK
...
ALTER TABLE USED_TRADE_POST_IMG_LIST_TB
ADD CONSTRAINT UTPIL_TB_IMG_PATH_PK
...
-- 마일리지 적립내역 -> 회원정보
ALTER TABLE MILEAGE_HISTORY_TB
ADD CONSTRAINT MILEAGE_HTR_TB_MEM_ID_PK_FK
FOREIGN KEY(MEM_ID_PK)
...
-- 중고거래 게시글 -> 중고거래 상태
ALTER TABLE USED_TRADE_POST_TB
ADD CONSTRAINT USE_TRD_PST_TB_USE_TRD_ST_PK_FK
...
-- 중고거래 게시글 -> 회원정보
ALTER TABLE USED_TRADE_POST_TB
ADD CONSTRAINT USE_TRD_PST_TB_MEM_ID_PK_FK
FOREIGN KEY(MEM_ID_PK)
REFERENCES MEMBER_TB(MEM_ID_PK);
