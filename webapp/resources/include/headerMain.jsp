...
<body>
	...
	<div id="menu-container">
		<a href="./main" class="menu-item" id="logo"> <img alt="logo"
			src="${pageContext.request.contextPath}/image/logo.png" width="50" /></a>

		<a href="./info" class="menu-icon1" style="display: none;">about</a> <a
			href="./store" class="menu-icon2" style="display: none;">shoes</a> <a
			href="./usedStore" class="menu-icon3" style="display: none;">used-item</a>
